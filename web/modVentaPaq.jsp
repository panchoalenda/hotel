  ...
  <body class="u-body">
    ...
    <section class="u-clearfix u-image u-typography-custom-page-typography-8--Introduction u-white u-section-1" id="sec-a326">
      ...
      <span class="u-icon u-icon-circle u-text-white u-icon-5"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 49.94 49.94" style=""><use xlink:href="#svg-0558"></use></svg><svg class="u-svg-content" viewBox="0 0 49.94 49.94" x="0px" y="0px" id="svg-0558" style="enable-background:new 0 0 49.94 49.94;"><path d="M48.856,22.731c0.983-0.958,1.33-2.364,0.906-3.671c-0.425-1.307-1.532-2.24-2.892-2.438l-12.092-1.757
        ...
        <h1 class="u-text u-text-3">MODIFICAR VENTA</h1>
        <div class="u-form u-form-1">

          <form action="SvBuscarVenta" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" name="form-1" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-581c" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Ingrese la venta a modificar" id="name-581c" name="num_venta" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
           <div class="u-align-left u-form-group u-form-submit">
                <button type="submit" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-26 u-btn-1">BUSCAR VENTA A MODIFICAR</button>
            </div>                            
        ...
        <div class="u-form u-gradient u-form-2">
          ...
          <form action="SvModificarVta" method="POST" class="u-clearfix u-form-spacing-19 u-form-vertical u-inner-form" name="form" style="padding: 13px;">
              <div class="u-form-date u-form-group u-form-group-4">
                  <%
                      HttpSession misession3 = request.getSession();
                  String vta = (String) misession3.getAttribute("vta");
                  %>
              <label for="text-07cc" class="u-label u-label-3">Venta Número </label>
              <input type="text" placeholder="" id="text-07cc" readonly="readonly" name="vta" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" value="<%=vta%>">
            </div>
            ...
            <div class="u-form-date u-form-group u-form-group-4">
              ...
              <input type="text" placeholder="" id="text-07cc" name="idEmple" value="<%=%>" readonly="true"><br>
                <label for="text-07cc" class="u-label u-label-3">Empleado</label>
                <input type="text" placeholder="" id="text-07cc" name="asigEmpleado" value="<%=%>" readonly="true" class="u-border-1 u-border-grey-30  u-input-rectangle u-white">
