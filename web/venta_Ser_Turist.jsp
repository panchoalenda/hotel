...
<html style="font-size: 16px;">
    ...
    <title>Venta Servicio Turístico</title>
  ...
  <body class="u-body">
    ...
    <section class="u-clearfix u-image u-typography-custom-page-typography-8--Introduction u-white u-section-1" id="sec-a326">
      ...
      <span class="u-icon u-icon-circle u-text-white u-icon-5"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 49.94 49.94" style=""><use xlink:href="#svg-0558"></use></svg><svg class="u-svg-content" viewBox="0 0 49.94 49.94" x="0px" y="0px" id="svg-0558" style="enable-background:new 0 0 49.94 49.94;"><path d="M48.856,22.731c0.983-0.958,1.33-2.364,0.906-3.671c-0.425-1.307-1.532-2.24-2.892-2.438l-12.092-1.757
        ...
        <h1 class="u-text u-text-3">VENTA SERVICIO TURISTICO</h1>
        <div class="u-form u-form-1">

          <form action="SvBuscaCliente1" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" name="form-1" style="padding: 10px;">
        ...
        <div class="u-form u-gradient u-form-2">
          ...
          <form action="SvVenta_Serv_Turist" method="POST" class="u-clearfix u-form-spacing-19 u-form-vertical u-inner-form" name="form" style="padding: 13px;">
              <div class="u-form-date u-form-group u-form-group-4">
                  <%
                      Controladora control=new Controladora();
                      int cod_paq =control.traerCodServicio()+1;
                  %>
              <label for="text-07cc" class="u-label u-label-3">Servicio Número </label>
            ...
            <div class="u-form-group u-form-name u-form-group-3">
              ...
              <%   
                  ...
                  String datoCliente = (String) misession1.getAttribute("verificado"); %>
            ...
            <div class="u-form-group u-form-name u-form-group-3">
              ...
              <%   
                  ...
                  String datoCliente2 = (String) misession0.getAttribute("verificado"); %>
            ...
            <div class="u-form-date u-form-group u-form-group-4">
             ...
             <div class="u-form-date u-form-group u-form-group-4">
              <label for="text-07cc" class="u-label u-label-3">Fecha Servicio Turístico</label>
            ...
            <div class="u-form-date u-form-group u-form-group-4">
             ...
             <div class="u-form-date u-form-group u-form-group-4">
                 <label for="text-07cc" class="u-label u-label-3">SELECCIONE EL SERVICIO A VENDER</label><br>
             </div>
            ...
            <div class=" u-form-group  u-form-group-5">                
                <input type="radio" id="checkbox" name="cod_servi" value="<%=ser.getCodigo_servicio()%>" >
