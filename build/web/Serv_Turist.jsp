        ...
        <h1 class="u-text u-text-white u-text-2">HOTEL <span style="font-weight: 700;">ALENDA</span></h1>
            ...
            c0.19,0.585,0.041,1.191-0.4,1.621l-8.749,8.528C37.866,30.65,37.481,31.835,37.681,32.998z"></path></svg>
                ...
                <center><svg viewbox="-50 0 200 10">
                 ...
                 <form  action="SvConsultaServ" method="POST">
                    <button type="submit" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-26 u-btn-1">LISTA DE SERVICIOS</button>                
                </form>
                <br><br><br><br>
